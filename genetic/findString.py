...
class individual:
    ...
    #mutate mutationRate proportion of time
    def tryMutate(self):
        for i in range(0, strLen):
...
#optionally breed two random picked members in population
...
def calculateOverall(population, generationNo):
    ...
    if generationNo == 1 or (generationNo+1) % 25 == 0 or int(highest) == 1:
...
def Main():
    ...
    while int(highest) != 1:
        ...
        newData = calculateOverall(population, generationNo)
